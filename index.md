...
venue: "Pawsey Supercomputing Centre"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
humantime: "9:30 am - 2:00 pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
instructor: ["Tarun Bonu", "Edric Matwiejew"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helpers: ["Rebecca", "David"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["edric.matwiejew@research.uwa.edu.au","tarunbonu@gmail.com", "rebecca.green@anu.edu.au", "dbadams@iinet.net.au"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
